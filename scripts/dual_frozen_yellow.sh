...
#############
# t = 1020 if 10x10 
# t = 1386 if 7 x7 x7 cube

echo -e "\n  Recording Grid Data..\n"
rosbag record --duration=1385 -O  yellow_frozen.bag /polaris_sensor/raw_points &
...
mv $PWD/outputs_conversion/yellow_frozen/polaris_sensor/raw_points.csv $PWD/yellow_frozen.csv;
