...
echo -e "${Bold_t}  PSM1/JOINT2 ENCODER QUALITY TEST${RS}"
...
rosrun cwru_davinci_playfile playback_jointspace /home/sxh759/catkin_ws/src/automatic_calibration/play/jsp/PSM1_intrinsic_calibration_playfiles_for_tool_mk_xi/01_joint_2_incremental_PSM1/01_j2_pre_pose.jsp;
sleep 10;
...
rosrun cwru_davinci_playfile playback_jointspace /home/sxh759/catkin_ws/src/automatic_calibration/play/jsp/PSM1_intrinsic_calibration_playfiles_for_tool_mk_xi/01_joint_2_incremental_PSM1/02_j2_arc.jsp;
sleep 200;
...
rosrun cwru_davinci_playfile playback_jointspace /home/sxh759/catkin_ws/src/automatic_calibration/play/jsp/PSM1_intrinsic_calibration_playfiles_for_tool_mk_xi/01_joint_2_incremental_PSM1/03_j2_still_samples_j4_90_deg.jsp;
sleep 115;
...
echo -e "${Bold_t}  \nPSM1/JOINT2 ENCODER QUALITY DATA ACQUIRED.${RS}"