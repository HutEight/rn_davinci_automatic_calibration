...
#############
# t = 1020 if 10x10 
# t = 1385 if 7 x7 x7 cube

echo -e "\n  Recording Grid Data..\n"
rosbag record --duration=1385 -O  green_frozen.bag /polaris_sensor/stray_markers &
rosrun cwru_davinci_playfile playback_portalspace /home/sxh759/catkin_ws/src/automatic_calibration/play/psp/dual_frozen/green_frozen.psp;
sleep 1386;
...
mv $PWD/outputs_conversion/green_frozen/polaris_sensor/stray_markers.csv $PWD/green_frozen.csv;
