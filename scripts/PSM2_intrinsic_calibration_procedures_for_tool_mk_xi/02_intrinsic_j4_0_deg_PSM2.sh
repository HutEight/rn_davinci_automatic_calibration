...
echo -e "${Bold_t}  PSM2 INTRINSIC CALIBRATION${RS}"
...
mv $PWD/outputs_conversion/09_yellow_j5_arc_01_at_j3_14cm/polaris_sensor/targets.csv $PWD/09_yellow_j5_arc_01_at_j3_14cm.csv;
mv $PWD/outputs_conversion/10_yellow_j6_arc_01_at_j3_14cm/polaris_sensor/targets.csv $PWD/10_yellow_j6_arc_01_at_j3_14cm.csv;
...
sed -i -e 's:/polaris_link,::g' $PWD/09_yellow_j5_arc_01_at_j3_14cm.csv;
sed -i -e "1d" $PWD/09_yellow_j5_arc_01_at_j3_14cm.csv
sed -i -e 's:/polaris_link,::g' $PWD/10_yellow_j6_arc_01_at_j3_14cm.csv;
sed -i -e "1d" $PWD/10_yellow_j6_arc_01_at_j3_14cm.csv
...
mv $PWD/09_yellow_j5_arc_01_at_j3_14cm.csv $exedir/csv/09_yellow_j5_arc_01_at_j3_14cm.csv;
mv $PWD/10_yellow_j6_arc_01_at_j3_14cm.csv $exedir/csv/10_yellow_j6_arc_01_at_j3_14cm.csv;
...
rm 09_yellow_j5_arc_01_at_j3_14cm.bag;
rm 10_yellow_j6_arc_01_at_j3_14cm.bag;

echo -e "${Bold_t}  \nPSM2 INTRINSIC CALIBRATION DATA ACQUIRED.${RS}"
