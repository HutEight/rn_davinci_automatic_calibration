...
echo -e "${Bold_t}  PSM2/JOINT1 ENCODER QUALITY TEST${RS}"
...
rosrun cwru_davinci_playfile playback_jointspace /home/sxh759/catkin_ws/src/automatic_calibration/play/jsp/PSM2_intrinsic_calibration_playfiles_for_tool_mk_xi/01_plus_joint_1_incremental_PSM2/01_j1_pre_pose.jsp;
sleep 10;
...
rosrun cwru_davinci_playfile playback_jointspace /home/sxh759/catkin_ws/src/automatic_calibration/play/jsp/PSM2_intrinsic_calibration_playfiles_for_tool_mk_xi/01_plus_joint_1_incremental_PSM2/02_j1_arc.jsp;
sleep 200;
...
rosrun cwru_davinci_playfile playback_jointspace /home/sxh759/catkin_ws/src/automatic_calibration/play/jsp/PSM2_intrinsic_calibration_playfiles_for_tool_mk_xi/01_plus_joint_1_incremental_PSM2/03_j1_still_samples_j4_0_deg.jsp;
sleep 335;
...
bash /home/sxh759/catkin_ws/src/rosbag_to_matlab/scripts/bag_to_csv.sh $PWD/02_j1_arc.bag $PWD/outputs_conversion;
bash /home/sxh759/catkin_ws/src/rosbag_to_matlab/scripts/bag_to_csv.sh $PWD/03_j1_still_samples_j4_0_deg.bag $PWD/outputs_conversion;
...
echo -e "${Bold_t}  \nPSM2/JOINT1 ENCODER QUALITY DATA ACQUIRED.${RS}"